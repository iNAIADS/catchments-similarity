...
def plot_network(G, quantities, nodesize=None, suffix='', do_plot_labels=True, bicolor=False, add_cbar=True, cbar_label=None, label_size=6.0):
...
def plot_WQ(df_WQ, suffix=''):
    ...
    for quantity in quantities:
        ...
        plt.savefig('boxplot_%s_%s' % (quantity.replace('.', ''), suffix), facecolor='w', dpi=300)
        #plt.close()
